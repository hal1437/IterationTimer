...
struct TimerListsView: View {
    ...
    @ObservedObject var viewModel = TimerListsViewModel(repository: WidgetUpdateIterationTimerRepository(dataStore: DataStoreSynchronizer(local: UserDefaults.appGroups, remote: NSUbiquitousKeyValueStore.default)))
