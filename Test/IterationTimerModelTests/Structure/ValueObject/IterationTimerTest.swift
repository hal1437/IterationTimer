...
class IterationTimerTest: XCTestCase {
    ...
    func testUnexpedtedInitialize() throws {
        ...
        XCTAssertThrowsError(try IterationTimerSettings(title: "xxx", category: .game, maxStamina: 0, duration: 222), "スタミナが0では初期化出来ないこと")
        XCTAssertThrowsError(try IterationTimerSettings(title: "xxx", category: .game, maxStamina: 111, duration: 0), "durationが0では初期化出来ないこと")
    }
}
